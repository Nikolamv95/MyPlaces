...
class DatabaseHandler(context: Context) :
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        // Creating the table
        val CREATE_HAPPY_PLACE_TABLE = ("CREATE TABLE " + TABLE_NAME_HAPPY_PLACE + "("
    ...
    override fun onUpgrade(db: SQLiteDatabase?, oldVersion: Int, newVersion: Int) {
        ...
        db!!.execSQL("DROP TABLE IF EXISTS $TABLE_NAME_HAPPY_PLACE")
        onCreate(db)
    }
    ...
    fun addHappyPlace(happyPlace: HappyPlaceModel): Long {
        ...
        val result = db.insert(TABLE_NAME_HAPPY_PLACE, null, contentValues)
        db.close()
    ...
    fun getHappyPlacesList(): ArrayList<HappyPlaceModel> {
        ...
        val selectQuery = "SELECT * FROM $TABLE_NAME_HAPPY_PLACE"
    ...
    fun deleteHappyPlace(happyPlace: HappyPlaceModel): Int {
        val db = this.writableDatabase
        val success = db.delete(TABLE_NAME_HAPPY_PLACE, "$KEY_ID = ${happyPlace.id}", null)
        db.close()
    ...
    companion object {
        ...
        private const val TABLE_NAME_HAPPY_PLACE = "HappyPlacesTable"
